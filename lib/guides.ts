...
const foundationalGuides: Guide[] = [
  {
    slug: "compare-loans-by-total-cost", category: "Borrowing", title: "How to compare loans by total cost—not the advertised payment", description: "A practical framework for comparing APR, fees, term, payment, and flexibility across competing loan offers.", calculatorSlug: "loan-payment", readTime: "8 min", reviewed: "August 9, 2026",
  ...
  {
    slug: "mortgage-affordability-beyond-payment", category: "Home buying", title: "Mortgage affordability: the costs your payment calculator cannot see", description: "Build a complete home budget around repayments, taxes, insurance, fees, maintenance, and rate risk.", calculatorSlug: "mortgage-payment", readTime: "9 min", reviewed: "August 9, 2026",
  ...
  {
    slug: "build-emergency-fund", category: "Saving", title: "How to build an emergency fund that matches your actual risk", description: "Size a cash buffer from essential expenses, income stability, dependants, insurance, and access needs.", calculatorSlug: "emergency-fund", readTime: "7 min", reviewed: "August 9, 2026",
  ...
  {
    slug: "debt-avalanche-vs-snowball", category: "Debt", title: "Debt avalanche vs snowball: choosing a payoff system you can sustain", description: "Compare interest-first and balance-first payoff methods, then build a plan that survives real life.", calculatorSlug: "debt-payoff", readTime: "8 min", reviewed: "August 9, 2026",
  ...
  {
    slug: "retirement-scenario-planning", category: "Retirement", title: "Retirement projections without false precision", description: "Use ranges for returns, inflation, fees, contributions, and retirement length instead of relying on one optimistic number.", calculatorSlug: "retirement-savings", readTime: "10 min", reviewed: "August 9, 2026",
  ...
  {
    slug: "inflation-and-real-returns", category: "Investing", title: "Inflation, nominal returns, and the number that matters: purchasing power", description: "Understand why a growing account can still buy less, and compare investments on a real-return basis.", calculatorSlug: "real-investment-return", readTime: "7 min", reviewed: "August 9, 2026",
  ...
  {
    slug: "freelance-rate-guide", category: "Income", title: "How to set a freelance rate that covers the work clients never see", description: "Convert take-home income, non-billable time, business costs, tax, leave, and risk into a sustainable rate floor.", calculatorSlug: "freelance-rate", readTime: "8 min", reviewed: "August 9, 2026",
  ...
  {
    slug: "investment-fees-compound", category: "Investing", title: "The quiet compounding cost of investment fees", description: "See how recurring fees reduce the capital that remains available to compound over long horizons.", calculatorSlug: "investment-return", readTime: "7 min", reviewed: "August 9, 2026",
...
export const guides: Guide[] = [...foundationalGuides, ...seoGuides];
