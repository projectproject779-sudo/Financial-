...
export default async function GuidePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const schema = { "@context": "https://schema.org", "@type": "Article", headline: guide.title, description: guide.description, dateModified: "2026-08-09", author: { "@type": "Person", name: "Shuxrat Asliddinov", jobTitle: "Founder and Publisher", url: "/authors/numora-editorial-team" }, publisher: { "@type": "Organization", name: "Numora" } };
