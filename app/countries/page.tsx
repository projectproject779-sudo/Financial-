...
export const metadata: Metadata = { title: "Financial Tools by Country", description: "Local starting points, official financial resources, and currency-ready calculators for the US, UK, Canada, Australia, and India.", alternates: { canonical: "/countries" } };
