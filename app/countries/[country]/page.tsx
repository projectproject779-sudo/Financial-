...
export default async function CountryPage({ params }: { params: Promise<{ country: string }> }) {
  ...
  const pageUrl = absoluteUrl(`/countries/${country.slug}`);
  const schema = { "@context": "https://schema.org", "@type": "CollectionPage", "@id": `${pageUrl}#collection`, name: `Numora financial tools for ${country.name}`, url: pageUrl, description: country.intro, inLanguage: "en", isPartOf: { "@id": absoluteUrl("/#website") }, about: { "@type": "Country", name: country.name } };
