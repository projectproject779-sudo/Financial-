...
export default function sitemap(): MetadataRoute.Sitemap {
  const core = ["", "/calculators", "/countries", "/guides", "/guides/apr-vs-interest-rate", "/guides/compound-interest", "/guides/savings-goals", "/about", "/methodology", "/editorial-policy", "/authors/numora-editorial-team", "/sources", "/corrections", "/partners", "/advertise", "/privacy", "/terms"];
