...
export const metadata: Metadata = { title: "24 Free Financial Calculators", description: "Explore 24 free calculators for debt, loans, mortgages, saving, investing, budgeting, retirement, and financial independence.", alternates: { canonical: "/calculators" } };
